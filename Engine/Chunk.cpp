    ...
    for(auto x = 0; x < ChunkData::BLOCKS_X; x++) {
        for (auto y = 0; y < ChunkData::BLOCKS_Y; y++) {
            for (auto z = 0; z < ChunkData::BLOCKS_Z; z++) {
                ...
                if (negXCond) {
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 0), glm::vec3(x, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 1), glm::vec3(x, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 2), glm::vec3(x, y + 1, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 3), glm::vec3(x, y + 1, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 4), glm::vec3(x, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 5), glm::vec3(x, y + 1, z + 1) });
                }
                ...
                if (posXCond) {
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 0), glm::vec3(x + 1, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 1), glm::vec3(x + 1, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 2), glm::vec3(x + 1, y + 1, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 3), glm::vec3(x + 1, y + 1, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 4), glm::vec3(x + 1, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 5), glm::vec3(x + 1, y + 1, z) });
                }
                ...
                if (negYCond) {
                    vertices.emplace_back(Vertex { texLookup.at(offset_bottom + 0), glm::vec3(x, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_bottom + 1), glm::vec3(x, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_bottom + 2), glm::vec3(x + 1, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_bottom + 3), glm::vec3(x + 1, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_bottom + 4), glm::vec3(x, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_bottom + 5), glm::vec3(x + 1, y, z) });
                }
                ...
                if (posYCond) {
                    vertices.emplace_back(Vertex { texLookup.at(offset_top + 0), glm::vec3(x, y + 1, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_top + 1), glm::vec3(x, y + 1, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_top + 2), glm::vec3(x + 1, y + 1, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_top + 3), glm::vec3(x + 1, y + 1, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_top + 4), glm::vec3(x, y + 1, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_top + 5), glm::vec3(x + 1, y + 1, z + 1) });
                }
                ...
                if (negZCond) {
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 0), glm::vec3(x + 1, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 1), glm::vec3(x, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 2), glm::vec3(x + 1, y + 1, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 3), glm::vec3(x + 1, y + 1, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 4), glm::vec3(x, y, z) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 5), glm::vec3(x, y + 1, z) });
                }
                ...
                if (posZCond) {
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 0), glm::vec3(x, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 1), glm::vec3(x + 1, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 2), glm::vec3(x, y + 1, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 3), glm::vec3(x, y + 1, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 4), glm::vec3(x + 1, y, z + 1) });
                    vertices.emplace_back(Vertex { texLookup.at(offset_side + 5), glm::vec3(x + 1, y + 1, z + 1) });
                }
            }
        }
    }
